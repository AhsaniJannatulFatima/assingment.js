...
var rupontiMile = feetToMile(senior[0]);
console.log(rupontiMile);
var anishaMile = feetToMile(15840);
console.log(anishaMile);
var mohonaMile = feetToMile(21120);
console.log(mohonaMile);
...
//tinyFriend
var friendName = ['Ruponti', 'Anisha', 'Amena'];
